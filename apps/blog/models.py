...
class BlogTypeModel(BaseModel):
    ...
    index = models.SmallIntegerField(verbose_name='优先级', default=0)
...
class BlogModel(BaseModel):
    ...
    # tag = models.ManyToManyField(verbose_name='标签', to='BlogTagModel')
    ...
    blog_type = models.ForeignKey(verbose_name='博文分类', to='BlogTypeModel', default='2')
    BLOG_CLS_CHOICES = (
        (1, '原创'),
        (2, '转载'),
    )
